...
To compile in a Linux64 environment it is necessary to use PAServer by creating a Docker Container deriving from the image made available by Embarcadero
...
Per compilare in ambiente Linux64 è necessario utilizzare PAServer attraverso la creazione di un Docker Container derivante dall'image messa a disposizione da Embarcadero
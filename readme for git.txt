...
The Server application can be compiled in Windows 32 bit and Linux 64 bit environments
...
L'application Server è compilabile in ambiente Windows 32 bit e Linux64 bit 
